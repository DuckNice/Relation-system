...
// ----------------- RULES THAT MIGHT HAPPEN (REACTION RULES)
		...
		argueRulesToTrigger.Add(relationSystem.pplAndMasks.GetRule("sabotage")); argueRulesToTrigger.Add(relationSystem.pplAndMasks.GetRule("deny"));
...
*/
		...
		convincetoleaveguildRulesToTrigger.Add(relationSystem.pplAndMasks.GetRule("deny")); 
